...
sys.path.insert(
    0,
    str(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))) + os.sep + '',
)
sys.path.insert(
    0,
...
author = 'Paul Westenthanner, Will McGinnis'
...
man_pages = [(master_doc, 'categoryencoders', 'Category Encoders Documentation', [author], 1)]
